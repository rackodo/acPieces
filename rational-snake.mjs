// Rational Snake, 2024.8.01.19.41.41.637
// A snake game where you eat fruit and grow accordingly. No funny business here, no sir.
// (MODIFIED BY @bash)
...
function boot({
  ...
  foodGen = () => {
	counter += 1;
    food = {
      color: (counter % 2 == 0 ? [46, 171, 38] : [55, 194, 45]),
